...
To better understand GPU APIs for the web as well as Gaussian splatting, I implemented a Gaussian splat viewer with WebGPU and TypeScript. I used [antimatter15's](https://github.com/antimatter15/splat) viewer as a reference.
